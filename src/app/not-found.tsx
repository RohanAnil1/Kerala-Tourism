...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-kerala-green/5 to-kerala-water/5">
      <div className="text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/destinations" className="bg-white text-kerala-green border-2 border-kerala-green px-8 py-3 rounded-full font-medium hover:bg-kerala-green/5 transition-colors">
