...
import { BarChart3, MapPin, FileText, Users, Settings, PlusCircle, Eye, Edit, Trash2, Search, TrendingUp, Globe, Camera, Shield, Bell, Menu, X, Home } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 pt-16">
      {/* Top Bar */}
      <div className="fixed top-16 left-0 right-0 z-30 bg-white dark:bg-gray-900 border-b dark:border-gray-800 h-14 flex items-center px-4 justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-display text-lg font-bold text-gray-900 dark:text-white">Admin Dashboard</h1>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link href="/" className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400 hover:text-kerala-green">
      ...
      <div className="flex pt-14">
        {/* Sidebar */}
        <aside className={`fixed lg:static inset-y-0 left-0 z-20 w-64 bg-white dark:bg-gray-900 border-r dark:border-gray-800 transform transition-transform duration-300 pt-28 lg:pt-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div key={i} className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm">
          ...
          <div className="space-y-3">
            {analytics.topPages.map((page, i) => (
              <div key={i} className="flex items-center justify-between py-2">
                ...
                <span className="text-sm font-semibold text-gray-900 dark:text-white">{page.views.toLocaleString()}</span>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Destinations</h2>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-800 border-b dark:border-gray-700">
            <tr>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Name</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">District</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Status</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Views</th>
              <th className="text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y dark:divide-gray-800">
            {destinations.map(d => (
              <tr key={d.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{d.district}</td>
                ...
                <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{d.views.toLocaleString()}</td>
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-gray-500"><Eye size={16} /></button>
                    <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-gray-500"><Edit size={16} /></button>
    ...
    <div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-800 border-b dark:border-gray-700">
            <tr>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Title</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Status</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Date</th>
              <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Views</th>
              <th className="text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase px-6 py-4">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y dark:divide-gray-800">
            {posts.map(p => (
              <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{p.date}</td>
                <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{p.views.toLocaleString()}</td>
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-gray-500"><Eye size={16} /></button>
                    <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg text-gray-500"><Edit size={16} /></button>
    ...
    <div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-sm text-center">
        <div className="max-w-md mx-auto">
          ...
          <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Drag & Drop Media Files</h3>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Support for JPEG, PNG, WebP, MP4 up to 50MB</p>
          <button className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-xl text-sm hover:bg-gray-200 dark:hover:bg-gray-700">
            Browse Files
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
          {['Munnar Hills', 'Backwater Sunset', 'Kathakali', 'Fort Kochi'].map((name, i) => (
            <div key={i} className="relative group bg-gray-100 dark:bg-gray-800 rounded-xl aspect-square flex items-center justify-center">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div className="relative">
            ...
            <input type="text" placeholder="Search users..." className="pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm outline-none focus:ring-2 focus:ring-kerala-green/30" />
          </div>
          <button className="flex items-center gap-2 bg-kerala-green text-white px-4 py-2 rounded-xl text-sm hover:bg-kerala-green/90">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex items-center justify-between py-3 border-b dark:border-gray-800 last:border-0">
              <div className="flex items-center gap-3">
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Global Meta Tags</h3>
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Site Title</label>
              <input type="text" defaultValue="Kerala Tourism - God's Own Country" className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none" />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Meta Description</label>
              <textarea defaultValue="Explore the enchanting beauty of Kerala..." rows={3} className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none resize-none" />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Keywords</label>
              <input type="text" defaultValue="Kerala tourism, backwaters, Munnar, Alleppey, God's Own Country" className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none" />
            </div>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Sitemap & Robots</h3>
          <div className="flex gap-4">
            ...
            <button className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-xl text-sm hover:bg-gray-200 dark:hover:bg-gray-700">Edit robots.txt</button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between py-3 border-b dark:border-gray-800 last:border-0">
                ...
                <button className={`w-12 h-6 rounded-full transition-colors relative ${item.enabled ? 'bg-kerala-green' : 'bg-gray-300 dark:bg-gray-700'}`}>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Security Headers</h3>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 font-mono text-xs text-gray-600 dark:text-gray-400 space-y-1">
...
function SettingsTab() {
  return (
    <div>
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm">
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Site Configuration</h3>
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Site Name</label>
              <input type="text" defaultValue="Kerala Tourism" className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none" />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Contact Email</label>
              <input type="email" defaultValue="info@keralatourism.org" className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none" />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 block">Default Language</label>
              <select className="w-full px-4 py-2 border dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-xl text-sm focus:ring-2 focus:ring-kerala-green/30 outline-none">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between py-3 border-b dark:border-gray-800 last:border-0">
                ...
                <button className={`px-4 py-1.5 rounded-lg text-sm ${item.connected ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700'}`}>
